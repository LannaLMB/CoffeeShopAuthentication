...
namespace CoffeeShopAuthentication.Controllers
{
    public class CoffeeShopController : Controller
    {
        ...
        public ActionResult SaveNewItem(Item NewItem)
        {
            ...
            //foreach (var ItemID in CoffDB.Items)
            //{
            //    if (NewItem == ItemID)
            //    {
            //        Console.WriteLine("Item ID Aready Exists!  Select Another Number.");
            //    }
            //}
            ...
            return RedirectToAction("CoffeeProducts", "Home");
        }
        ...
        public ActionResult SaveUpdates(Item ToBeUpdated)
        {
            ...
            return RedirectToAction("../Home/CoffeeProducts");
        }
        ...
        public ActionResult SearchItem(string Name)
        {
            ...
            return View("../Home/CoffeeProducts");
